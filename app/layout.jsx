...
const gothicA1 = localFont({
  src: [
    {
      path: "../public/fonts/GothicA1-Regular.ttf",
      weight: "400",
      style: "normal",
    },
    {
      path: "../public/fonts/GothicA1-Bold.ttf",
      weight: "700",
      style: "normal",
    },
  ],
...
export const metadata = {
  ...
  description:
    "GAPs Data Repository is an open-access platform providing comprehensive qualitative and quantitative data on national return regimes, launched in 2024 as part of the Horizon Europe project GAPs.",
  openGraph: {
    title: "GAPs Data Repository",
    description:
      "GAPs Data Repository is an open-access platform providing comprehensive qualitative and quantitative data on national return regimes, launched in 2024 as part of the Horizon Europe project GAPs.",
