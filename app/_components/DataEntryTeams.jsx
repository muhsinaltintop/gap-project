...
const DataEntryTeams = () => {
  return (
    ...
    <div className='flex mt-2'> <span className='font-bold'>Türkiye:</span> Ela Gökalp Aras (PI) <span className='ml-2 mr-2'><Link href={'mailto:ela.gokalparas@sri.org.tr'}><Mail color='#0d7dff'/></Link></span> | Umutcan Yüksel <span className='ml-2 mr-2'><Link href={'mailto:umutcan.yuksel@sri.org.tr'}><Mail color='#0d7dff'/></Link></span></div>
